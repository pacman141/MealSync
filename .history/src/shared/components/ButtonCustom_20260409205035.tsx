...
import { ButtonCustomProps, ButtonTextColor } from "../types/types";
import { Colors } from "../../assets";

const ButtonCustom = ({ title, type, style, titleColor = "dark", onPress }: ButtonCustomProps) => {
    const ButtonText = (color: ButtonTextColor) => <Text style={{ color: color === "dark" ? Colors.text : Colors.primaryDark }}>{title}</Text>;
